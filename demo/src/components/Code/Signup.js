  ...
  return (
    ...
    <div className={registerstyle.container}>
      <div className={registerstyle.register}>
        <form>
          <h1 className={registerstyle.head}  data-testid="Heading">Create your account</h1>
          <input
            type="text"
            name="firstName"
            id="firstname"
          ...
          <button id="btn" className={basestyle.button_common} onClick={signupHandler} data-testid="Head">
            Register
          </button>
        </form>
